...
class _ListingDetailScreenState extends State<ListingDetailScreen> {
  ...
  // Reads listing details aloud when user taps the speaker button
  void _speakListing(BuildContext context) {
    ...
    final text =
        ...
        'Category: ${l.category}. '
        'Quantity available: ${l.formattedQuantity}. '
        'Sold by ${l.sellerName} from ${l.sellerLocation}. '
  ...
  Widget build(BuildContext context) {
    ...
    final inCart      = cart.items.any((i) => i.listing.id == widget.listing.id);
          ...
          SliverAppBar(
            ...
            actions: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(
                    voice.isSpeaking ? Icons.volume_up_rounded : Icons.volume_up_outlined,
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: Colors.black45, borderRadius: BorderRadius.circular(10)),
                    child: Row(children: [
                      Icon(Icons.shopping_cart_outlined, color: t.primary, size: 18),
                      if (cart.count > 0) ...[
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: widget.listing.imageUrls.isNotEmpty
                  ? Image.network(widget.listing.imageUrls.first, fit: BoxFit.cover,
                      errorBuilder: (_, __, ___) => Container(
                          color: t.card,
                          child: Icon(Icons.image_outlined, color: t.primary.withOpacity(0.3), size: 60)))
                  : Container(
                      color: t.card,
                      child: Icon(Icons.storefront_outlined, color: t.primary.withOpacity(0.3), size: 60)),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  Container(
                      ...
                      child: Text(widget.listing.category,
                          style: TextStyle(color: t.primary, fontSize: 11, fontWeight: FontWeight.w700))),
                  const SizedBox(width: 8),
                  Container(
                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                      decoration: BoxDecoration(
                          color: Colors.green.withOpacity(0.12), borderRadius: BorderRadius.circular(8)),
                ...
                Row(children: [
                  ...
                  Text('• ${widget.listing.formattedQuantity} available',
                ...
                Container(
                  ...
                  child: Row(children: [
                    Container(
                        ...
                        child: Center(
                            child: Text(
                                widget.listing.sellerName.isNotEmpty
                                    ? widget.listing.sellerName[0].toUpperCase() : 'S',
                                style: TextStyle(color: t.primary, fontWeight: FontWeight.w800, fontSize: 18)))),
                    const SizedBox(width: 14),
                    Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(widget.listing.sellerName,
                          style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 14)),
                      const SizedBox(height: 2),
                      Row(children: [
                        Icon(Icons.location_on_outlined, color: Colors.white.withOpacity(0.35), size: 12),
                        const SizedBox(width: 4),
                        Text(widget.listing.sellerLocation,
                ...
                GridView.count(
                  ...
                  mainAxisSpacing: 10,
                  children: [
                    _chip(Icons.scale_outlined, 'Quantity', widget.listing.formattedQuantity, t),
                    _chip(Icons.currency_rupee, 'Currency', widget.listing.currency, t),
                    _chip(Icons.category_outlined, 'Category', widget.listing.category, t),
                    _chip(Icons.access_time_outlined, 'Posted', _timeAgo(widget.listing.createdAt), t),
                  ],
                ),
      ...
      bottomNavigationBar: Container(
        ...
        child: isOwner
            ? ElevatedButton.icon(
                ...
                label: const Text('Delete listing', style: TextStyle(fontWeight: FontWeight.w700)),
            ...
            : Row(children: [
                    ...
                    child: ElevatedButton.icon(
                        onPressed: () {
                          if (inCart) {
                            ...
                            cart.add(widget.listing);
                            ScaffoldMessenger.of(context).hideCurrentSnackBar();
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              content: Text('${widget.listing.title} added to cart!'),
                ...
                GestureDetector(
                    ...
                    child: Container(
                        ...
                        child: Icon(Icons.chat_bubble_outline, color: t.primary, size: 22))),
              ]),
      ),
    );
  }
  ...
  Future<void> _openChat(BuildContext context) async {
    ...
    final chatId = ([currentUser.uid, widget.listing.sellerId]..sort()).join('_');
    await FirebaseFirestore.instance.collection('chats').doc(chatId).set({
      'participants': [currentUser.uid, widget.listing.sellerId],
    ...
    if (context.mounted) {
      Navigator.push(context, MaterialPageRoute(
          builder: (_) => ChatScreen(
                chatId: chatId,
                otherName: widget.listing.sellerName,
                otherId: widget.listing.sellerId,
                listingTitle: widget.listing.title,
              )));
    }
  }
  ...
  Future<void> _deleteListing(BuildContext context, AppTheme t) async {
    ...
    if (confirm == true) {
      await FirebaseFirestore.instance.collection('listings').doc(widget.listing.id).delete();
